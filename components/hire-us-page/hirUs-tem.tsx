...
const HirUsPageComponentTemp: FC = () => {
	...
	const sendMessageHandler = (event: React.FormEvent) => {
		...
		console.log(enteredEmail, enteredName, enteredMessage, number);
					...
					<ContactContainer>
						...
						<RightContent>
							...
							<div className='actions'>
								<CustomButton onClick={sendMessageHandler}>
									SUBMIT
								</CustomButton>
							</div>
						</RightContent>
...
export default memo(HirUsPageComponentTemp);
